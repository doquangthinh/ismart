                ...
                <div class="section-detail clearfix">
                    <div class="thumb-wp fl-left">
                        <a href="" title="" id="main-thumb">
                            <img id="zoom" style="width:350px; height:312px;" src="<?php echo $item['product_thumb']; ?>" data-zoom-image="<?php echo $item['product_thumb'] ?>"/>
                        </a>
                        <div id="list-thumb">
                            <a href=""  data-image="<?php echo $item['product_thumb'] ?>" data-zoom-image="<?php echo $item['product_thumb'] ?>">
                                <img id="zoom"  src="<?php echo $item['product_thumb'] ?>" />
                            </a>
                            <a href=""  data-image="<?php echo $item['product_thumb'] ?>" data-zoom-image="<?php echo $item['product_thumb'] ?>">
                                <img id="zoom" src="<?php echo $item['product_thumb'] ?>" />
                            </a>
