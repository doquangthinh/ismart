            ...
            <div class="section" id="list-product-wp">
                ...
                <div class="section-head clearfix">
                    ...
                    <div class="filter-wp fl-right">
                        <p class="desc">Hiển thị <strong><?php echo  count($select_sort_mobile) + count($select_sort_laptop)  ?></strong> sản phẩm</p>
                ...
                <div class="section-detail">
                    ...
                    <?php
                    if (!empty($select_sort_mobile)) {
                    ?>
                        <ul class="list-item clearfix">
                            <?php
                            foreach ($select_sort_mobile as $item) {
                            ?>
                                <li>
                ...
                <h3 class="section-title fl-left">Laptop</h3>
                    <?php
                    if (!empty($select_sort_laptop)) {
                    ?>
                        <ul class="list-item clearfix">
                            <?php
                            foreach ($select_sort_laptop as $item) {
                            ?>
                                <li>
                                    <a href="<?php echo $item['url'] ?>" title="" class="thumb">
                                        <img src="<?php echo $item['product_thumb'] ?>">
