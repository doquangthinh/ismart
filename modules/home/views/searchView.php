    ...
    <div class="wp-inner">
        <div class="main-content fl-right">
            ...
            <div class="section" id="list-product-wp">
                ...
                <div class="section-detail">
                    <?php
                    if (!empty($look_up_mobile)) {
                    ?>
                        <ul class="list-item clearfix">
                            <?php
                            foreach ($look_up_mobile as $item) {
                            ?>
                                <li>
                                    <a href="<?php echo $item['url'] ?>" title="" class="thumb">
                                        <img src="<?php echo $item['product_thumb'] ?>">
                    ...
                    ?>
                        <p>Không tìm thấy <strong> <?php echo $search ?> </strong> trong Danh mục điện thoại </p>
                    <?php
                    }
                    ?>
            ...
            <div class="section" id="list-product-wp">
                ...
                <div class="section-detail">
                    <?php
                    if (!empty($look_up_laptop)) {
                    ?>
                        <ul class="list-item clearfix">
                            <?php
                            foreach ($look_up_laptop as $item) {
                            ?>
                                <li>
                                    <a href="<?php echo $item['url'] ?>" title="" class="thumb">
                                        <img src="<?php echo $item['product_thumb'] ?>">
                    ...
                    ?>
                        <p>Không tìm thấy <strong> <?php echo $search ?> </strong> trong Danh mục Laptop </p>
                    <?php
                    }
                    ?>
