                    ...
                    <div class="wp-inner clearfix">
                        ...
                        <ul id="main-menu" class="fl-left">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="?mod=page&action=add_post" title="">Thêm mới</a> 
                                    </li>
                                    <li>
                                        <a href="?mod=page&action=list_post" title="">Danh sách bài viết</a> 
                                    </li>
                                    <li>
                                        <a href="?mod=page&action=list_cat" title="">Danh mục bài viết</a> 
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="?mod=products&action=add_product" title="">Thêm mới</a> 
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                <li>
                                        <a href="?mod=sell&action=detail_order" title="">Thông tin đơn hàng </a> 
                                    </li>
                                    <li>
                                        <a href="?mod=sell&action=list_order" title="">Danh sách đơn hàng</a> 
                                    </li>
                                    <li>
