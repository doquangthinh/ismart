<div class="sidebar fl-left">
    ...
    <div class="section" id="filter-product-wp">
        ...
        <div class="section-detail">
            <form method="POST" action="?mod=products&action=filter&cat_id=2">
                <table>
                    <thead>
                        <tr>
                            <td colspan="2">Giá</td>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Dưới 15.000.000đ</td>
                        </tr>
                        <tr>
                            <td><input type="radio" name="r-price"  value=" BETWEEN 15000000 AND 20000000 " ></td>
                            <td>15.000.000đ - 20.000.000đ</td>
                        </tr>
                        <tr>
                            <td><input type="radio" name="r-price" value=">= 20000000"></td>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td><input type="radio" name="r-brand" value="Dell"></td>
                            <td>Dell</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><input type="radio" name="r-brand" value="Asus"></td>
                            <td>Asus</td>
                        </tr>
                        <tr>
                            <td><input type="radio" name="r-brand" value="HP"></td>
                            <td>HP</td>
                        </tr>
                        <tr>
                            <td><input type="radio" name="r-brand" value="MSI"></td>
                            <td>MSI</td>
                        </tr>
                        <tr>
                            <td><input type="radio" name="r-brand" value="Acer"></td>
                            <td>Acer</td>
                        </tr>
