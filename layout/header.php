                    ...
                    <div class="wp-inner">
                        ...
                        <div id="main-menu-wp" class="fl-right">
                            <ul id="main-menu" class="clearfix">
                                ...
                                <li>
                                    <a href="blog-1.html" title="">Blog</a>
                                </li>
                                <li>
                                    <a href="gioi-thieu-2.html" title="">Giới thiệu</a>
                                </li>
                                <li>
                                    <a href="lien-he-3.html" title="">Liên hệ</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div id="dropdown">
                                    ...
                                    ?>
                                        ...
                                        <div class="total-price clearfix">
                                            ...
                                            <p class="price fl-right"> <?php echo currency_format(get_total_order_cart()) ?> </p>
                                        </div>
